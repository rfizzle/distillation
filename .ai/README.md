...
Domain-specific review emphasis (e.g. the single brew choke point every potion
resolution must flow through, and the vanilla-parity guarantee when feature
toggles are off) lives in `AGENTS.md`, which the workflows always inject into
the prompt.
